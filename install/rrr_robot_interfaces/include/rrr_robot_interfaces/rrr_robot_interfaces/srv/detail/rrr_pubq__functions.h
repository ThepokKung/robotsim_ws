...
#ifndef RRR_ROBOT_INTERFACES__SRV__DETAIL__RRR_PUBQ__FUNCTIONS_H_
#define RRR_ROBOT_INTERFACES__SRV__DETAIL__RRR_PUBQ__FUNCTIONS_H_
...
/// Initialize srv/RRRPubq message.
/**
...
/// Create srv/RRRPubq message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rrr_robot_interfaces__srv__RRRPubq_Request__init().
...
/// Destroy srv/RRRPubq message.
/**
 * It calls
 * rrr_robot_interfaces__srv__RRRPubq_Request__fini()
...
/// Check for srv/RRRPubq message equality.
/**
...
/// Initialize array of srv/RRRPubq messages.
/**
...
/// Finalize array of srv/RRRPubq messages.
/**
 * It calls
 * rrr_robot_interfaces__srv__RRRPubq_Request__fini()
...
/// Create array of srv/RRRPubq messages.
/**
 * It allocates the memory for the array and calls
 * rrr_robot_interfaces__srv__RRRPubq_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RRRPubq messages.
/**
 * It calls
 * rrr_robot_interfaces__srv__RRRPubq_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RRRPubq message array equality.
/**
...
/// Copy an array of srv/RRRPubq messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rrr_robot_interfaces__srv__RRRPubq_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rrr_robot_interfaces
...
/**
 * It calls
 * rrr_robot_interfaces__srv__RRRPubq_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rrr_robot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * rrr_robot_interfaces__srv__RRRPubq_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rrr_robot_interfaces
...
/**
 * It calls
 * rrr_robot_interfaces__srv__RRRPubq_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RRR_ROBOT_INTERFACES__SRV__DETAIL__RRR_PUBQ__FUNCTIONS_H_
