...
struct RRRTeleop_Request_
{
  ...
  using _teleop_target_type =
    geometry_msgs::msg::Point_<ContainerAllocator>;
  _teleop_target_type teleop_target;
  ...
  Type & set__teleop_target(
    const geometry_msgs::msg::Point_<ContainerAllocator> & _arg)
  {
    this->teleop_target = _arg;
    return *this;
  }
  ...
  bool operator==(const RRRTeleop_Request_ & other) const
  {
    ...
    if (this->teleop_target != other.teleop_target) {
      return false;
    }
    return true;
  }
