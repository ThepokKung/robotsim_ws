...
bool rrr_robot_interfaces__srv__rrr_teleop__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // teleop_run
    PyObject * field = PyObject_GetAttrString(_pymsg, "teleop_run");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->teleop_run = (Py_True == field);
    Py_DECREF(field);
  }
  {  // frame_ref
...
PyObject * rrr_robot_interfaces__srv__rrr_teleop__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // teleop_run
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->teleop_run ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "teleop_run", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
